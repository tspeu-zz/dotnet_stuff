--*****************************************************************************************************************
-- *** LOOP THROUGH FACULTIES - CATEGORIES ***
--*****************************************************************************************************************
-- ****   TEST TotalAmount ON CourseData BY Country  
...
WHERE  SeoUrl NOT IN ('eir', 'posgrado', 'a1','a2','b1','b2','c1', 'c2', 'curso-oficial-idiomas')
--,'clase-conversacion-idiomas', 'curso-oficial-idiomas','evaluacion-oficial-idiomas', 'examen-oficial-idiomas');  
-----
...
BEGIN
    ...
    BEGIN   
        ...
        -- TEST        
        SELECT  cd.id 
                ,cd.SeoUrl, a.SeoUrl AS C_DATA_FACTULTY, ct.SeoUrl AS C_DATA_CATEGORY
...
--          
   ...
   --,(select CEILING((cd.ScholarshipAmount ) / 100) * 100) AS CEILING_SCHOLARSHIP
...
--------------------
 ...
 --       ) *2,-1) /2)
    ...
    END AS NEW_ScholarshipAmount -- ProductScholarshipCountryModifiers
        ...
        ,cd.TotalPromoAmount --ProductCouponDiscountFacultyStudyModifiers
...
--------  -- ProductCouponDiscountFacultyStudyModifiers
    ...
    ELSE --'ES LATAM'
        ...
        END    
    END AS NEW_TotalPromoAmount_DISCOUNT
